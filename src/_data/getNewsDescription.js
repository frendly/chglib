...
const cache = new Map();
const fallbackDescription = (year) => `Архив новостей за ${year} год. Важные события, научные открытия и мероприятия, произошедшие в научном центре.`;

// Функция для получения meta description из файла или возврат fallback
// @param {String} year - год для поиска
export const getNewsDescription = (year) => {
