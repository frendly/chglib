...
3. Запустить локальный сервер `yarn watch`, откроектся браузер с сайтом
4. Открыть редактор vs code на рабочем столе
5. Вносим изменения...
6. Изменения нужно сохранить в репозитории(хранилище)
...
7. Остановить локальный сервер в консоли ctrl + C
8. Отправить изменения на наш сервер `yarn deploy`
